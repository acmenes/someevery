...
returns true if every single number in the array is odd. If any of the values in the 
...
true if there are no duplicate values (more than one element in the array that 
    has the same value as another). If there are any duplicates, the function should 
    return false.
